...
public class tequilaLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "tequilaLauncherModelDelegate";
    ...
    public tequilaLauncherModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
