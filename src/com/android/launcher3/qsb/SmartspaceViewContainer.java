...
import com.tequila.launcher.tequilaLauncher;
import com.tequila.launcher.tequilaLauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        tequilaLauncher launcher = (tequilaLauncher) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        tequilaLauncherModelDelegate delegate = (tequilaLauncherModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        tequilaLauncher launcher = (tequilaLauncher) ActivityContext.lookupContext(getContext());
